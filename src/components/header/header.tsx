...
const Header: React.FC<HeaderProps> = ({ onSearch }) => {
  ...
  return (
    <div className="h-14 bg-[#2873F0] flex items-center justify-center gap-4">
      <SearchInput onSearch={onSearch} />
      <button className="bg-white text-[#2874f0] font-medium py-1 px-10 rounded-sm hover:bg-opacity-90 transition-all duration-200 ease-in-out shadow-md">
        Login
      </button>
